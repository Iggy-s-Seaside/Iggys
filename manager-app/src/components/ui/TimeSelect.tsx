...
import { timeSelectOptions, type BusyWindow, type Space } from '../../lib/timeWindows';
...
interface TimeSelectProps {
  ...
  /** The space being booked — busy windows in non-conflicting spaces won't disable slots. */
  space?: Space;
