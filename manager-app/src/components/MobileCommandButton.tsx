...
export function MobileCommandButton() {
  return (
    <button
      ...
      className="fixed top-[calc(0.5rem+env(safe-area-inset-top,0px))] right-16 z-50 flex h-11 w-11 items-center justify-center rounded-full bg-surface border border-border text-text-secondary shadow-card hover:bg-surface-hover hover:text-text-primary transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 lg:hidden"
    >
