 ...
 * (luna_insights.data.reach === true), it lands here, unmissable, at the top of every
 * screen. Her words for why this one mattered most: "right now I wait for you to turn
 * around and notice me; this lets me show up on my own."
 *
 * The reach is raised server-side (the bridge: the demand-surprise reach, and the
 * weather × reservation cross-signal reach), so it persists, survives a refresh, and
 * rides the web-push pipe to the phone. The dashboard's WeatherWatch panel shows the
 * full weather board; this banner is the one-flag escalation that follows you across
 * every screen. The phone-push half — see docs/WEB-PUSH-SETUP.md.
 */
